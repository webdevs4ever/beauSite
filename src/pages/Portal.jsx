          ...
          <form onSubmit={handleSubmit} className="glass-dark rounded-2xl p-6 flex flex-col gap-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={4}
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/20 focus:outline-none focus:border-brand-teal transition-colors resize-none"
                placeholder="Please allow up to 1000 characters"
              />
            </div>
